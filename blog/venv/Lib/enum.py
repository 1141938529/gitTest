...
class _EnumDict(dict):
    ...
    def __setitem__(self, key, value):
        ...
        If an enum member name is used twice, an errors is raised; duplicate
...
class EnumMeta(type):
    ...
    def __new__(metacls, cls, bases, classdict):
        ...
        # fail.  Rather than have the errors show up later and possibly far
    ...
    def __delattr__(cls, attr):
        # nicer errors message when someone tries to delete an attribute
        # (see issue19025).
